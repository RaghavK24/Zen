...
from application.api import api, UserAPI, SectionAPI, BookAPI, OrderAPI, RequestAPI, IssueAPI
hapi = Api(app)
...
hapi.add_resource(RequestAPI, "/api/request","/api/request","/api/request/<int:user_id>/<int:book_id>")
hapi.add_resource(IssueAPI, "/api/issue", "/api/issue/<int:id>","/api/issue/status/<int:status>", "/api/issue/<int:user_id>/<int:book_id>")
