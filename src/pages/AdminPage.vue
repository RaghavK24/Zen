        ...
        <div class="row">
          <div class="d-flex flex-column justify-content-between col-auto bg-dark min-vh-100">
            <ul class="nav nav-pills flex-column mt-2 mt-sm-0" id="menu">
              ...
              >
                <router-link to="/admin/sections" class="nav-link text-white" aria-current="page">
              ...
              <li
                class="nav-item d-inline-flex align-items-center"
                :class="route.name == 'adminbooks' ? 'active' : ''"
              >
                <router-link to="/admin/books" class="nav-link text-white" aria-current="page">
                  <mdicon name="book-open-blank-variant-outline" class="text-white" />
                  <span class="ms-2 fs-6">Books</span>
                </router-link>
              </li>
              <li
                class="nav-item d-inline-flex align-items-center"
                :class="route.name == 'adminrequests' ? 'active' : ''"
              >
                <router-link to="/admin/requests" class="nav-link text-white" aria-current="page">
                  <mdicon name="book-alert-outline" class="text-white" />
                  <span class="ms-2 fs-6">Requests</span>
                </router-link>
              </li>
              <li
                class="nav-item d-inline-flex align-items-center"
                :class="route.name == 'adminissues' ? 'active' : ''"
              >
                <router-link to="/admin/issue" class="nav-link text-white" aria-current="page">
                  <mdicon name="book-check-outline" class="text-white" />
                  <span class="ms-2 fs-6">Issues</span>
                </router-link>
              </li>
            </ul>
          </div>
